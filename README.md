...
## License
This repository (including the ONNX artifact) is provided under the Apache License 2.0 (Apache-2.0). See [LICENSE](/LICENSE) and [NOTICE](/NOTICE) for details.
...
본 저장소의 소스 및 배포 산출물(ONNX 포함)은 **Apache License 2.0(Apache-2.0)** 를 따릅니다. 자세한 내용은 [LICENSE](/LICENSE) 및 [NOTICE](/NOTICE)를 참고하세요.
